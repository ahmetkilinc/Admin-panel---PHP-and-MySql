...
<div style="overflow:auto;" class='maincontent'>
	...
	<form method="post" action="passwordChangeSS.php">
		<table>
		  <tr>
			<td><img class="imgSettings" src="images/settings.png">&nbsp;&nbsp;Yeni Şifreniz:</td>
			<td><input type="text" name="yeniSifre" pattern=".{6,}" value="" required title="Şifreniz en az 6 haneli olmalıdır."></td>
		  </tr>
		</table>
		<button class="buttonGeri" type="button" onclick="funcGeri()">Geri</button>
		<button class="buttonGonder" type="submit">Degistir</button>
	</form>
</div>	
	</body>
	<head>
